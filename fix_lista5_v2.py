...
CHANNEL_MAPPING = {
    "Al Jazeera Español": {"tvg_id": "AlJazeeraEnglish.es", "epg_source": "IPTV-EPG ES"},
    "Euronews Español": {"tvg_id": "Euronews.es", "epg_source": "IPTV-EPG ES"},
    "BBC World News": {"tvg_id": "BBCWorldNews.fr", "epg_source": "IPTV-EPG FR"},
    "CNN Internacional": {"tvg_id": "CNNInternational.fr", "epg_source": "IPTV-EPG FR"},
    "France Info": {"tvg_id": "FranceInfo.fr", "epg_source": "IPTV-EPG FR"},
    "BFM TV": {"tvg_id": "BFMTV.fr", "epg_source": "IPTV-EPG FR"},
    "ETB Basque": {"tvg_id": "ETB1.es", "epg_source": "IPTV-EPG ES"},
    "Galicia TV America": {"tvg_id": "TVG-TVGalicia.es", "epg_source": "IPTV-EPG ES"},
    "Rai Italia": {"tvg_id": "RaiItalia.us", "epg_source": "IPTV-EPG US"},
    "TVE Internacional": {"tvg_id": "TVEInternacional.es", "epg_source": "IPTV-EPG ES"},
    "TV5Monde Español": {"tvg_id": "TV5Monde.fr", "epg_source": "IPTV-EPG FR"},
    "Bolivia TV": {"tvg_id": "BoliviaTV.bo", "epg_source": "IPTV-EPG BO"},
    "TVN Chile": {"tvg_id": "TVNChile.cl", "epg_source": "IPTV-EPG CL"},
    "Telemundo Internacional": {"tvg_id": "Telemundo.us", "epg_source": "IPTV-EPG US"},
    "ESPN8 The Ocho": {"tvg_id": "ESPN8TheOcho.us", "epg_source": "IPTV-EPG US"},
    "ESPN Deportes": {"tvg_id": "ESPNDeportes.us", "epg_source": "IPTV-EPG US"},
    "CBS Sports Golazo": {"tvg_id": "CBSSportsGolazoNetwork.us", "epg_source": "IPTV-EPG US"},
    "FanDuel TV": {"tvg_id": "FanDuelTV.us", "epg_source": "IPTV-EPG US"},
    "FIFA+": {"tvg_id": "FIFA+.us", "epg_source": "IPTV-EPG US"},
    "Red Bull TV": {"tvg_id": "RedBullTV.us", "epg_source": "IPTV-EPG US"},
    "beIN Sports XTRA": {"tvg_id": "beINSPORTSXtra.us", "epg_source": "IPTV-EPG US"},
    "VH1": {"tvg_id": "VH1.us", "epg_source": "IPTV-EPG US"},
    "VMusic": {"tvg_id": "VMusic.ar", "epg_source": "IPTV-EPG US"},
    "M2O TV": {"tvg_id": "M2OTV.it", "epg_source": "IPTV-EPG IT"},
    "Deluxe Music": {"tvg_id": "DeluxeMusic.de", "epg_source": "IPTV-EPG DE"},
}
...
def download_epg(epg_url: str, cache_prefix: str = "/tmp/epg") -> Optional[str]:
    cache_file = f"{cache_prefix}_{epg_url.split('/')[-1].replace('.gz','')}.xml"
    try:
...
def main():
    ...
    for ch in channels:
        ...
        epg_source = mapping["epg_source"] if mapping else None
        epg_url = epg_urls.get(epg_source) if epg_source else None
        ...
        if epg_result["status"] in ["completo", "parcial"]:
            ...
            print(f"  --- {channel_name[:35]:<35} [{tvg_id[:25] if tvg_id else 'N/A':<25}] Sem prog. EPG: {epg_source or 'N/A'}")
    ...
    with open("lista5_epg_report.txt", "w", encoding="utf-8") as f:
        ...
        for ch in channels_with_epg:
            ...
            f.write(f"  EPG: {ch.get('epg_source','N/A')}\n")
