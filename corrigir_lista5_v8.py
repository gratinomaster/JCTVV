...
def main():
    print("=" * 60)
    print("CORRECAO FINAL lista5.m3u v8")
    print("=" * 60)
    ...
    with open("lista5_relatorio.txt", 'w', encoding='utf-8') as f:
        ...
        f.write("Canais brasileiros com EPG:\n")
        for name in ["GLOBO NEWS", "BAND NEWS", "CNN BRASIL", "RECORD NEWS", "JOVEM PAN NEWS", "BM&C NEWS"]:
