...
print(f"   Download: {len(m3u_content)} bytes")
...
print()
print("=" * 60)
print("3. Filtrando EPG pelos canais do M3U...")
print("=" * 60)
matched_ids = set()
...
with gzip.open(TEMP_EPG, "rb") as f:
...
print()
print("=" * 60)
print("4. Escrevendo EPGFULL.xml.gz...")
print("=" * 60)
...
if prog_hoje > 0 and prog_amanha > 0:
    print()
    print("=" * 60)
    print("   EPG FUNCIONANDO! Programas para hoje e amanhã disponíveis.")
    print("=" * 60)
else:
    print()
    print("   EPG COM PROBLEMAS! Faltam programas para hoje ou amanhã.")
    sys.exit(1)
